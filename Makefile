...
${OBJ_DIR}/assg09-library.o: ${SRC_DIR}/assg09-library.cpp ${INC_DIR}/assg09-library.hpp
${OBJ_DIR}/${PROJECT_NAME}-tests.o: ${SRC_DIR}/${PROJECT_NAME}-tests.cpp ${INC_DIR}/assg09-library.hpp
